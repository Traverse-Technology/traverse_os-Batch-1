            ...
            <div class="col-md-4">
                <div class="card mt-3 shadow p-3 mb-5 bg-white rounded" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-outline-primary float-left" onclick="addToCart('[{name:2, age:30, car:null}]')">Buy</a>
                        <a href="#" class="btn btn-outline-primary float-left" onclick="addToCart(<?php echo "'".json_encode(selectData($db,'products','WHERE id='.$product[0]))."'"?>)">Buy</a>
